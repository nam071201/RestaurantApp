        ...
        flex flex-col items-center justify-center gap-4'>
            {
              ...
              <div className='group flex justify-center items-center flex-col 
                  border-2 border-dotted border-gray-300 w-full h-255 md:h-420
                          ...
                          {!imageAsset ? (
                            <>
                              <label className='w-full h-full flex flex-col items-center justify-center cursor-pointer'>
                                  ...
                                  <input type="file" name="uoloadimage" accept='image/*' onChange={uploadImage}
                                    className="w-0 h-0"/>
                              </label>
                            </> 
                           ) : (
              ...
              <div className='flex items-center w-full'>
                    ...
                    border-none outline-none bg-emerald-500 px-12 py-2 rounded-lg text-lg
                     text-white font-semibold' onClick={saveDetails}>
                          Save
                     </button>
              </div>
        </div>
